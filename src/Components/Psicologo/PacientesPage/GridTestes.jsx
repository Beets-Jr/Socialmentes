  ...
  return (
    <div>
        <Box className={styles.containerTestes} sx={{ flexGrow: "1" }}>
            ...
            <BlueLine />
            <Grid container rowGap={2} columnGap={3} className={styles.gridContainer}>
                <Grid item xs={12} sm={6} md={4} lg={3.75} sx={{ display: "flex" }} className={styles.gridItem}>
                    ...
                    <div className={styles.cardHalf}>
                       <p>05/09/2024</p>
                       <p>Denver</p>
                       <p noWrap className={styles.statusTeste}>Não finalizado</p> 
                    </div>
                </Grid>
                <Grid item xs={12} sm={6} md={4} lg={3.75} sx={{ display: "flex" }} className={styles.gridItem}>
                    <div className={styles.cardHalf}>
