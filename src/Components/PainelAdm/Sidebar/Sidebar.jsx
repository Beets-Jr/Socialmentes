...
const sidebarAllOptions = {
  ...
  sidebarOptionsPsy: [
    ...
    { icon: <ScheduleIcon />, text:'Agenda', to:'/painel-adm/agenda' },
    { icon: <SettingsOutlinedIcon style={{marginLeft: -2, color:'#FFFFFF'}}/>, text:'Instrumentos' , to:'/painel-adm/instrumentos' }
]
};
